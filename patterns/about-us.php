...
<div class="wp-block-group has-background" style="background-color:#2842b0;padding-top:100px;padding-bottom:100px;margin-top:0;margin-bottom:0;">
    ...
    <div class="wp-block-columns"><!-- wp:column {"width":"60%"} -->
        ...
        <div class="wp-block-column is-vertically-aligned-center" style="flex-basis: 40%">
            ...
            <h2 class="wp-block-heading has-base-color has-text-color has-link-color"
                ...
                <?php echo esc_html_x('We Work with team of creative people, digital marketing expert.', 'About section title', 'cadent-seo'); ?>
            </h2>
            <!-- /wp:heading -->
            ...
            <p class="has-base-2-color has-text-color has-link-color" style="margin-top:0px;margin-bottom:0px">
                <?php echo esc_html_x("There are many variations of passages of Lorem Ipsum available, but the majority have suffered altration in some form, by injected humour, words randomised words which don't look even slightly believable. If you are going to use a passage.", "About section description", 'cadent-seo'); ?>
            </p>
            <!-- /wp:paragraph -->
            ...
            <div class="wp-block-buttons"><!-- wp:button -->
                <div class="wp-block-button"><a class="wp-block-button__link wp-element-button">
                        <?php echo esc_html_x('Know More', 'About section button', 'cadent-seo'); ?>
                    </a></div>
                <!-- /wp:button -->
            </div>
            <!-- /wp:buttons -->
