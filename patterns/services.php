...
<!-- wp:group {"style":{"color":{"background":"#f3f8fd"},"spacing":{"padding":{"top":"100px","bottom":"100px"},"margin":{"top":"0px","bottom":"0px"}}},"layout":{"type":"constrained","contentSize":"1140px"}} -->
<div class="wp-block-group has-background"
    ...
    <!-- wp:group {"style":{"spacing":{"margin":{"top":"0px","bottom":"0px"},"blockGap":"0"}},"layout":{"type":"constrained","contentSize":"100%"}} -->
    <div class="wp-block-group" style="margin-top:0px;margin-bottom:0px">
        <!-- wp:columns {"style":{"spacing":{"margin":{"top":"0px","bottom":"0px"},"blockGap":{"left":"var:preset|spacing|50"}}}} -->
        <div class="wp-block-columns" style="margin-top:0px;margin-bottom:0px">
            <!-- wp:column {"width":"33.33%","style":{"spacing":{"padding":{"top":"30px","bottom":"30px","left":"30px","right":"30px"}}},"color":{"background":"#ffffff"}} -->
            <div class="wp-block-column has-background"
                style="padding-top:30px;padding-right:30px;padding-bottom:30px;padding-left:30px;flex-basis:33.33%;background-color:#ffffff;">
                <!-- wp:image {"id":45,"width":"60px","height":"60px","scale":"cover","sizeSlug":"full","linkDestination":"none"} -->
                <figure class="wp-block-image size-full is-resized">
                    <img src="<?php echo esc_url(get_parent_theme_file_uri('/assets/images/services/icon1.png')); ?>"
                        alt="" class="wp-image-45" style="object-fit:cover;width:60px;height:60px" />
                </figure>
                <!-- /wp:image -->
            ...
            <div class="wp-block-column has-background"
                style="padding-top:30px;padding-right:30px;padding-bottom:30px;padding-left:30px;flex-basis:33.33%;background-color:#ffffff;">
                <!-- wp:image {"id":46,"width":"60px","height":"60px","scale":"cover","sizeSlug":"full","linkDestination":"none"} -->
                <figure class="wp-block-image size-full is-resized">
                    <img src="<?php echo esc_url(get_parent_theme_file_uri('/assets/images/services/icon2.png')); ?>"
                        alt="" class="wp-image-46" style="object-fit:cover;width:60px;height:60px" />
                </figure>
                <!-- /wp:image -->
            ...
            <div class="wp-block-column has-background"
                style="padding-top:30px;padding-right:30px;padding-bottom:30px;padding-left:30px;flex-basis:33.33%;background-color:#ffffff;">
                <!-- wp:image {"id":47,"width":"60px","height":"60px","scale":"cover","sizeSlug":"full","linkDestination":"none"} -->
                <figure class="wp-block-image size-full is-resized">
                    <img src="<?php echo esc_url(get_parent_theme_file_uri('/assets/images/services/icon3.png')); ?>"
                        alt="" class="wp-image-47" style="object-fit:cover;width:60px;height:60px" />
                </figure>
                <!-- /wp:image -->
        ...
        <!-- wp:columns {"style":{"spacing":{"margin":{"top":"0px","bottom":"0px"},"padding":{"right":"0","left":"0"},"blockGap":{"left":"var:preset|spacing|50"}}}} -->
        <div class="wp-block-columns" style="margin-top:0px;margin-bottom:0px;padding-right:0;padding-left:0">
            <!-- wp:column {"width":"33.33%","style":{"spacing":{"padding":{"top":"30px","bottom":"30px","left":"30px","right":"30px"}}},"color":{"background":"#ffffff"}} -->
            <div class="wp-block-column has-background"
                style="padding-top:30px;padding-right:30px;padding-bottom:30px;padding-left:30px;flex-basis:33.33%;background-color:#ffffff;">
                <!-- wp:image {"id":45,"width":"60px","height":"60px","scale":"cover","sizeSlug":"full","linkDestination":"none"} -->
                <figure class="wp-block-image size-full is-resized">
                    <img src="<?php echo esc_url(get_parent_theme_file_uri('/assets/images/services/icon4.png')); ?>"
                        alt="" class="wp-image-45" style="object-fit:cover;width:60px;height:60px" />
                </figure>
                <!-- /wp:image -->
            ...
            <div class="wp-block-column has-background"
                ...
                <!-- wp:image {"id":46,"width":"60px","height":"60px","scale":"cover","sizeSlug":"full","linkDestination":"none"} -->
                <figure class="wp-block-image size-full is-resized">
                    <img src="<?php echo esc_url(get_parent_theme_file_uri('/assets/images/services/icon5.png')); ?>"
                        alt="" class="wp-image-46" style="object-fit:cover;width:60px;height:60px" />
                </figure>
                <!-- /wp:image -->
            ...
            <div class="wp-block-column has-background"
                ...
                <!-- wp:image {"id":47,"width":"60px","height":"60px","scale":"cover","sizeSlug":"full","linkDestination":"none"} -->
                <figure class="wp-block-image size-full is-resized">
                    <img src="<?php echo esc_url(get_parent_theme_file_uri('/assets/images/services/icon6.png')); ?>"
                        alt="" class="wp-image-47" style="object-fit:cover;width:60px;height:60px" />
                </figure>
                <!-- /wp:image -->
