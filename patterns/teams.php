...
<!-- wp:group {"style":{"spacing":{"padding":{"top":"100px","bottom":"100px"},"margin":{"top":"0px","bottom":"0px"}},"color":{"background":"#f3f8fd"}},"layout":{"type":"constrained","contentSize":"1140px"}} -->
<div class="wp-block-group has-background"
    ...
    <div class="wp-block-group" style="margin-top:0px;margin-bottom:0px">
        ...
        <div class="wp-block-columns"><!-- wp:column {"style":{"spacing":{"padding":{"right":"0px","left":"0px"}}}} -->
            <div class="wp-block-column" style="padding-right:0px;padding-left:0px">
                <!-- wp:image {"align":"center","id":54,"width":"320px","height":"auto","sizeSlug":"full","linkDestination":"none","className":"is-style-default"} -->
                <figure class="wp-block-image aligncenter size-full is-resized is-style-default">
                    <img src="<?php echo esc_url(get_parent_theme_file_uri('/assets/images/teams/img-1.png')); ?>"
                        alt="" class="wp-image-54" style="width:320px;height:auto" />
                </figure>
                <!-- /wp:image -->
                ...
                <!-- wp:social-links {"iconColor":"contrast","iconColorValue":"#111111","size":"has-normal-icon-size","style":{"spacing":{"margin":{"top":"0px","bottom":"0px"},"blockGap":{"left":"var:preset|spacing|10"}}},"className":"is-style-logos-only","layout":{"type":"flex","justifyContent":"center"}} -->
                <ul class="wp-block-social-links has-normal-icon-size has-icon-color is-style-logos-only"
                    style="margin-top:0px;margin-bottom:0px">
                    <!-- wp:social-link {"service":"facebook"} /-->
                    <!-- wp:social-link {"service":"linkedin"} /-->
                    <!-- wp:social-link {"service":"instagram"} /-->
                    <!-- wp:social-link {"service":"skype"} /-->
                </ul>
                <!-- /wp:social-links -->
            </div>
            <!-- /wp:column -->

            <!-- wp:column {"style":{"spacing":{"padding":{"right":"0px","left":"0px"}}}} -->
            <div class="wp-block-column" style="padding-right:0px;padding-left:0px">
                <!-- wp:image {"align":"center","id":55,"width":"320px","height":"auto","sizeSlug":"full","linkDestination":"none","className":"is-style-default"} -->
                <figure class="wp-block-image aligncenter size-full is-resized is-style-default">
                    <img src="<?php echo esc_url(get_parent_theme_file_uri('/assets/images/teams/img-2.png')); ?>"
                        alt="" class="wp-image-54" style="width:320px;height:auto" />
                </figure>
                <!-- /wp:image -->
            ...
            <!-- wp:column {"style":{"spacing":{"padding":{"right":"0px","left":"0px"}}}} -->
            <div class="wp-block-column" style="padding-right:0px;padding-left:0px">
                <!-- wp:image {"align":"center","id":56,"width":"320px","height":"auto","sizeSlug":"full","linkDestination":"none","className":"is-style-default"} -->
                <figure class="wp-block-image aligncenter size-full is-resized is-style-default">
                    <img src="<?php echo esc_url(get_parent_theme_file_uri('/assets/images/teams/img-3.png')); ?>"
                        alt="" class="wp-image-54" style="width:320px;height:auto" />
                </figure>
                <!-- /wp:image -->
