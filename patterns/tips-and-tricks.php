...
<!-- wp:group {"style":{"color":{"background":"#e7eef6"},"spacing":{"padding":{"top":"100px","bottom":"100px"},"margin":{"top":"0px","bottom":"0px"}}},"layout":{"type":"constrained","contentSize":"1140px"}} -->
<div class="wp-block-group has-background"
    ...
    <div class="wp-block-columns">
        ...
        <div class="wp-block-column" style="flex-basis:60%">
            ...
            <div class="wp-block-group has-background"
                style="background-color:#f3f8fd;padding-top:30px;padding-right:30px;padding-bottom:30px;padding-left:30px">
                ...
                <div class="wp-block-columns"><!-- wp:column {"verticalAlignment":"top","width":"10%"} -->
                    <div class="wp-block-column is-vertically-aligned-top" style="flex-basis:10%">
                        <!-- wp:image {"id":42,"width":"60px","sizeSlug":"full","linkDestination":"none"} -->
                        <figure class="wp-block-image size-full is-resized">
                            <img src="<?php echo esc_url(get_parent_theme_file_uri('/assets/images/icon.png')); ?>"
                                alt="" class="wp-image-42" style="width:60px" />
                        </figure>
                        <!-- /wp:image -->
                    </div>
                    <!-- /wp:column -->
                    ...
                    <div class="wp-block-column" style="flex-basis:90%">
                        ...
                        <div style="margin-top:0px;margin-bottom:0px;height:15px" aria-hidden="true"
